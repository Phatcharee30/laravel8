                            ...
                            <table class="table">
                                ...
                                @foreach($user as $item)
                                    <tr>
                                        ...
                                        <td>{{ $item->name }}</td><td>{{ $item->email }}</td><td>{{ $item->email_verified_at }}</td><td>{{ $item->password }}</td><td>{{ $item->remember_token }}</td><td>{{ $item->role }}</td><td>{{ isset($item->profile->no) ? $item->profile->no : "" }}</td>
